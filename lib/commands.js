...
import { askMedical } from "./medical.js";
...
async function cmdAsk(chatId, question) {
  if (!question) {
    return sendMessage(chatId, "🩺 *Медичний консультант*\n\nФормат: /ask ваше питання\n\nПриклад:\n/ask протокол лікування грижі L5-S1\n/ask діагностика ревматоїдного артриту\n/ask дозування мелоксикаму при остеоартрозі");
  }
...
/ask питання — консультація за протоколами
...
/expenses — сьогодні
/month — за місяць
/ask питання — медична консультація
/briefing — повний звіт дня`;
